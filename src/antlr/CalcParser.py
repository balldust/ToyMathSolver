...
class CalcParser(Parser):
    ...
    class EquationExpressionContext(EquationContext):
        ...
        ):  # actually a CalcParser.EquationContext
        ...
        def arithmetic_expr(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    CalcParser.Arithmetic_exprContext
                )
            else:
                return self.getTypedRuleContext(
                    CalcParser.Arithmetic_exprContext, i
                )
    ...
    class ArithmeticExpressionPowContext(Arithmetic_exprContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a CalcParser.Arithmetic_exprContext
            super().__init__(parser)
            self.copyFrom(ctx)
    ...
    class ArithmeticExpressionParensContext(Arithmetic_exprContext):
        ...
        def arithmetic_expr(self):
            return self.getTypedRuleContext(
                CalcParser.Arithmetic_exprContext, 0
            )
    ...
    def arithmetic_expr(self, _p: int = 0):
        ...
        localctx = CalcParser.Arithmetic_exprContext(
        ...
        try:
            ...
            if token in [CalcParser.LPAREN]:
                localctx = CalcParser.ArithmeticExpressionParensContext(
                    self, localctx
                )
                self._ctx = localctx
                _prevctx = localctx
                ...
                localctx = CalcParser.ArithmeticExpressionNumericEntityContext(
                    self, localctx
                )
                self._ctx = localctx
                _prevctx = localctx
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    if la_ == 1:
                        localctx = CalcParser.ArithmeticExpressionPowContext(
                            self,
                            CalcParser.Arithmetic_exprContext(
                        ...
                        self.pushNewRecursionContext(
                            localctx, _startState, self.RULE_arithmetic_expr
                        )
                        self.state = 62
                        ...
                        localctx = (
                            CalcParser.ArithmeticExpressionMultDivContext(
                                self,
                                CalcParser.Arithmetic_exprContext(
                                    self, _parentctx, _parentState
                                ),
                        ...
                        localctx = (
                            CalcParser.ArithmeticExpressionPlusMinusContext(
                                self,
                                CalcParser.Arithmetic_exprContext(
                                    self, _parentctx, _parentState
                                ),
    ...
    class NumericConstContext(Numeric_entityContext):
        def __init__(
            self, parser, ctx: ParserRuleContext
        ):  # actually a CalcParser.Numeric_entityContext
            super().__init__(parser)
            self.copyFrom(ctx)
    ...
    def arithmetic_expr_sempred(
        self, localctx: Arithmetic_exprContext, predIndex: int
    ):
        if predIndex == 0:
