...
class CalcListener(ParseTreeListener):
    ...
    def enterEquationExpression(
        self, ctx: CalcParser.EquationExpressionContext
    ):
        pass
    ...
    def enterArithmeticExpressionPow(
        self, ctx: CalcParser.ArithmeticExpressionPowContext
    ):
        pass

    # Exit a parse tree produced by CalcParser#ArithmeticExpressionPow.
    def exitArithmeticExpressionPow(
        self, ctx: CalcParser.ArithmeticExpressionPowContext
    ):
        pass

    # Enter a parse tree produced by CalcParser#ArithmeticExpressionParens.
    def enterArithmeticExpressionParens(
        self, ctx: CalcParser.ArithmeticExpressionParensContext
    ):
        pass

    # Exit a parse tree produced by CalcParser#ArithmeticExpressionParens.
    def exitArithmeticExpressionParens(
        self, ctx: CalcParser.ArithmeticExpressionParensContext
    ):
        pass

    # Enter a parse tree produced by CalcParser#ArithmeticExpressionNumericEntity.
    def enterArithmeticExpressionNumericEntity(
        self, ctx: CalcParser.ArithmeticExpressionNumericEntityContext
    ):
        pass

    # Exit a parse tree produced by CalcParser#ArithmeticExpressionNumericEntity.
    def exitArithmeticExpressionNumericEntity(
        self, ctx: CalcParser.ArithmeticExpressionNumericEntityContext
    ):
        pass

    # Enter a parse tree produced by CalcParser#ArithmeticExpressionMultDiv.
    def enterArithmeticExpressionMultDiv(
        self, ctx: CalcParser.ArithmeticExpressionMultDivContext
    ):
        pass

    # Exit a parse tree produced by CalcParser#ArithmeticExpressionMultDiv.
    def exitArithmeticExpressionMultDiv(
        self, ctx: CalcParser.ArithmeticExpressionMultDivContext
    ):
        pass

    # Enter a parse tree produced by CalcParser#ArithmeticExpressionPlusMinus.
    def enterArithmeticExpressionPlusMinus(
        self, ctx: CalcParser.ArithmeticExpressionPlusMinusContext
    ):
        pass

    # Exit a parse tree produced by CalcParser#ArithmeticExpressionPlusMinus.
    def exitArithmeticExpressionPlusMinus(
        self, ctx: CalcParser.ArithmeticExpressionPlusMinusContext
    ):
        pass
