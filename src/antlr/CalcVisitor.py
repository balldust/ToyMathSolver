...
class CalcVisitor(ParseTreeVisitor):
    ...
    def visitArithmeticExpressionNumericEntity(
    ...
    def visitArithmeticExpressionMultDiv(
    ...
    def visitArithmeticExpressionPlusMinus(
